...
public class ModScreenHandlers {
    ...
    public static ScreenHandlerType<ElectrolyserScreenHandler> ELECTROLYSER_SCREEN_HANDLER =
            new ExtendedScreenHandlerType<>(ElectrolyserScreenHandler::new);
    ...
    public static void registerScreenHandlers() {
        ...
        Registry.register(Registries.SCREEN_HANDLER, new Identifier(NoMansCraft.MOD_ID, "compressor"), ELECTROLYSER_SCREEN_HANDLER);
    }
}
