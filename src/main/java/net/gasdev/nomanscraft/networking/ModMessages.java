...
import net.gasdev.nomanscraft.networking.packet.FluidSyncS2CPacket;
...
public class ModMessages {
    ...
    public static final Identifier FLUID_SYNC_S2C_ID = new Identifier(NoMansCraft.MOD_ID, "fluid_sync_s2c");
    ...
    public static void registerS2CPackets() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(FLUID_SYNC_S2C_ID, FluidSyncS2CPacket::receive);
    }
}
